...
const useFHECounterWagmi_1 = require("~~/hooks/fhecounter-example/useFHECounterWagmi");
/*
...
const FHECounterDemo = () => {
    ...
    const { instance: fhevmInstance, status: fhevmStatus, error: fhevmError, } = (0, _fhevm_sdk_1.useFhevm)({
        provider,
        chainId,
        initialMockChains,
    ...
    //////////////////////////////////////////////////////////////////////////////
    const fheCounter = (0, useFHECounterWagmi_1.useFHECounterWagmi)({
    ...
    //////////////////////////////////////////////////////////////////////////////
    const buttonClass = "inline-flex items-center justify-center px-6 py-3 font-semibold shadow-lg " +
    ...
    return (<div className="max-w-6xl mx-auto p-6 space-y-6 text-gray-900">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-black">
        <button className={fheCounter.isDecrypted ? successButtonClass : primaryButtonClass} disabled={!fheCounter.canDecrypt} onClick={fheCounter.decryptCountHandle}>
        ...
        <button className={secondaryButtonClass} disabled={!fheCounter.canUpdateCounter} onClick={() => fheCounter.updateCounter(+1)}>
      ...
      {/* Messages */}
      {fheCounter.message && (<div className={sectionClass}>
...
exports.FHECounterDemo = FHECounterDemo;
function printProperty(name, value) {
    ...
    return (<div className="flex justify-between items-center py-2 px-3 bg-white border border-gray-200 w-full">
...
function printBooleanProperty(name, value) {
    return (<div className="flex justify-between items-center py-2 px-3  bg-white border border-gray-200 w-full">
      <span className="text-gray-700 font-medium">{name}</span>
      <span className={`font-mono text-sm font-semibold px-2 py-1 border ${value
